...
const Tags = ({contest}) => {
    ...
    return (
        <div className="d-flex align-items-center justify-content-center flex-wrap">
            ...
            <div className="d-flex align-items-center justify-content-center mx-1 px-1 rounded p-md-1 my-1" style={{ backgroundColor: '#A0522D'}}>
            ...
            <div className="d-flex align-items-center justify-content-center mx-1 px-1 rounded p-md-1 my-1" style={{ backgroundColor: '#edaf05' }}>
